...
const profile = profileDirectory('measure')
const chrome = spawn(
  CHROME,
...
/**
 * Chrome is killed in a `finally` below, so a throw anywhere after the spawn cannot leave it
 * holding the debugging port for the next run to trip over.
 */
let socket = null
