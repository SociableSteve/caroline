...
export interface Source {
  ...
  /**
   * Set when the item turned out to be a second telling of one another connector already covers:
...
/**
 * The item is a second telling of one another connector covers. As with resolution the first
