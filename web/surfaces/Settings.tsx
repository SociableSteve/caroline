    ...
    <div className="settings-surface">
      ...
      */}
          {mcpConsent !== undefined && (
            <Panel headingLevel={2} heading="An assistant is asking to connect">
              {mcpConsent === null ? (
                ...
                <div>
                  <p>
                    <strong>{mcpConsent.clientName ?? mcpConsent.clientId}</strong> is asking to
                    connect to Caroline over MCP. Once approved, it can read and change your board
                    exactly as chat can, through the same content policy, the same confirmation for
                    a delete or a bulk change, and the same undo.
                  </p>
                  <Facts>
          ...
          <Panel headingLevel={2} heading="Who Caroline is talking to">
            <p>
              Caroline tells the model your name so that it writes to you rather than about you. It
              is sent on every chat and planning call, including to a remote provider.
            </p>
